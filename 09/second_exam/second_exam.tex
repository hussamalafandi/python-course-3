...
\begin{enumerate}
      ...
      \item Nennen Sie zwei Entwurfsmuster und erklären Sie einen von ihnen. (2 Punkte)
            ...
            \newpage
      \item Der folgende Code enthält einen Fehler in Bezug auf \textbf{private Attribute} und \textbf{abstrakte Methoden}. Finden Sie die zwei Fehler und erklären Sie, warum sie problematisch sind. (2 Punkte)
