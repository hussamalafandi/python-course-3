...
\date{\DTMdisplaydate{2025}{4}{14}{-1}}
...
\begin{enumerate}
  \item Erklären Sie, \textbf{was} ein virtuelles Python-Environment ist und \textbf{warum} es in Projekten sinnvoll ist. (2 Punkte)
        \vfil
  \item Welche Befehle verwenden Sie, um ein virtuelles Environment mit \texttt{venv} zu \textbf{erstellen} und zu \textbf{aktivieren}? Schreiben Sie den entsprechenden Befehl. (2 Punkte)\\[0.3cm]
