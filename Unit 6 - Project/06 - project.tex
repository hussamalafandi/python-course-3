...
\subsection{Implementation sketch (CSV)}
\begin{lstlisting}[language=Python]
import csv
...
\toprule
\textbf{Category} & \textbf{What this means} & \textbf{Points} \\
\midrule
Correctness & Calculations are correct; save/load works reliably & 0--4 \\
Robustness & Handles invalid input gracefully; no crashes & 0--4 \\
Structure & Clear decomposition; responsibilities separated across modules & 0--4 \\
Readability & Good naming, consistent style, helpful comments/docstrings & 0--4 \\
Data handling & Appropriate use of list/dict/set; clean aggregations & 0--4 \\
\midrule
...
\vspace{6pt}
\textbf{Optional extensions} may improve your score within categories but do not replace missing MVP requirements.
...
\hrule
\vspace{8pt}
\textcolor{muted}{\small Tip: Keep your core logic in functions that return values. This will make Unit 14 (Testing) much easier.}
